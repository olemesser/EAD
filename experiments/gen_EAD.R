...
DOE<-expand_grid(N_FR = 50, # number of functional requirements
                 N_DD = 50, # number of physical domain elements
                 N_PrD = 50, # number of process domain elements
                 N_RD = 50, # number of resource domain elements
